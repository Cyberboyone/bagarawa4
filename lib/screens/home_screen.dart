      ...
      body: SafeArea(
        child: Column(
          children: [
            ...
            // Lessons list with banner ads. A banner is always shown at the end
            // of the list (for every course filter), and additionally every few
            // lessons while scrolling.
            Expanded(
              child: _lessons.isEmpty
                  ...
                  : ListView.builder(
                      ...
                      // +1 reserves the final item for the end-of-list banner.
                      itemCount: _lessons.length + 1,
                      itemBuilder: (context, index) {
                        // Banner ad pinned to the very end of the list so it
                        // appears for every filter ("every list").
